    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col text-end">
                <a href="{{ route('exportExercicios') }}" class="btn btn-secondary px-5">DESCARREGAR EXERCÍCIOS</a>
                <a href="{{ route('printExercicios') }}" class="btn btn-secondary px-5">IMPRIMIR EXERCÍCIOS</a>
            </div>
        </div>
    </div>
